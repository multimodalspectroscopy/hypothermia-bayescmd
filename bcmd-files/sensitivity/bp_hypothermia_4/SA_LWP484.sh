...
DATASET="LWP484"
OUTDIR1=`readlink -m "../../data/SA_results/bph_4/with_cellDeath/nrmse/${DATASET}"`
OUTDIR2=`readlink -m "../../data/SA_results/bph_4/with_cellDeath/nrmse_zero/${DATASET}"`

WORKDIR=$1
JOBFILE1="${WORKDIR}hypothermia_SA.dsimjob"
JOBFILE2="${WORKDIR}hypothermia_SA_zero.dsimjob"
