...
build/bp_hypothermia.model -i ${HOME}/hypothermia-bayescmd/data/ABC/debugging/bp_hypothermia/100519T1656/bp_hypothermia.input -o ${TMPDIR}/debug_coarse.tsv -d ${TMPDIR}/debug_fine.tsv
