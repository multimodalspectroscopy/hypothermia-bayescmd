#!/bin/bash -l
#$ -l h_rt=1:00:00
#$ -N LWP475_cellDeath_1
#$ -o /home/ucbpjru/Scratch/bph1/LWP475/out
#$ -e /home/ucbpjru/Scratch/bph1/LWP475/err
...
CONFIGFILE="${HOME}/hypothermia-bayescmd/config_files/abc/bp_hypothermia_0/bp_hypothermia_0_config.json"
...
tar -zcvf $HOME/Scratch/bph0/${DATASET}/batch_$JOB_NAME.$SGE_TASK_ID.tar.gz $TMPDIR
